  ...
  <div class="cart">
    ...
    <div class="cart-tool">
      <div class="select-all">
        <input class="chooseAll" type="checkbox" :checked="isChecked" @click="CheckAllUpadte" />
        <span>全选</span>
      </div>
      <div class="option">
        <a @click="DelectAll">删除选中的商品</a>
...
export default {
  ...
  methods: {
    ...
    updatecheck (cart, event) {
      ...
      this.$store.dispatch('getCheckedupdate', { skuId: cart.skuId, isChecked: check })
      this.getData()
    },
    //删除选中按钮
    async DelectAll () {
      await this.$store.dispatch('DelectAllChecked')
      this.getData()
    },
    // 全选删除按钮
